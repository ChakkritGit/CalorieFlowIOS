...
actor CoreMLBackend {
    ...
    /// temperature ลดจาก 0.7 เหลือ 0.4 เพราะภาษาไทยของโมเดล 1.5B หลุดประเด็นบ่อย
    /// ที่ 0.7 — ยิ่งกระจายความน่าจะเป็นกว้าง โมเดลที่ความรู้ภาษาไทยบางอยู่แล้วยิ่ง
    /// เดินออกนอกเรื่อง แลกกับการที่คำแนะนำจะซ้ำกันมากขึ้นเมื่อบริบทไม่เปลี่ยน
    /// ซึ่งรับได้กว่า เพราะการ์ดถูกแคชสิบนาทีอยู่แล้วและมีปุ่มสร้างใหม่ให้กด
    private func sample(from logits: [Float], temperature: Float = 0.4, topK: Int = 40) -> Int {
